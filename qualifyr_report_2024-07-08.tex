...
\toprule
\multicolumn{5}{l}{\bgroup\fontsize{10}{12}\selectfont \textbf{\textit{Neisseria gonorrhoeae}}\egroup{}} \\
...
\toprule
\multicolumn{17}{l}{\bgroup\fontsize{10}{12}\selectfont \textbf{\textit{Enterococcus faecalis}}\egroup{}} \\
...
\toprule
\multicolumn{12}{l}{\bgroup\fontsize{10}{12}\selectfont \textbf{\textit{Pseudomonas aeruginosa}}\egroup{}} \\
...
\begin{tabular}{c>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}>{\centering\arraybackslash}p{3cm}}
\toprule
\multicolumn{12}{l}{\bgroup\fontsize{10}{12}\selectfont \textbf{\textit{Acinetobacter baumannii}}\egroup{}} \\
\cmidrule(l{3pt}r{3pt}){1-12}
...
\toprule
\multicolumn{20}{l}{\bgroup\fontsize{10}{12}\selectfont \textbf{\textit{Klebsiella pneumoniae}}\egroup{}} \\
